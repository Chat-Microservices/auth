...
//go:generate minimock -i github.com/semho/chat-microservices/auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
type AuthServiceMock struct {
	...
	funcCreate          func(ctx context.Context, user *model.Detail, pass string) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, user *model.Detail, pass string)
	...
	GetListLogsMock          mAuthServiceMockGetListLogs

	funcUpdate          func(ctx context.Context, updateUser *model.UpdateUserRequest) (err error)
...
func NewAuthServiceMock(t minimock.Tester) *AuthServiceMock {
	...
	m.GetListLogsMock = mAuthServiceMockGetListLogs{mock: m}
	m.GetListLogsMock.callArgs = []*AuthServiceMockGetListLogsParams{}
...
func (mmCreate *mAuthServiceMockCreate) Expect(ctx context.Context, user *model.Detail, pass string) *mAuthServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &AuthServiceMockCreateParams{ctx, user, pass}
...
func (mmCreate *mAuthServiceMockCreate) Inspect(f func(ctx context.Context, user *model.Detail, pass string)) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Set(f func(ctx context.Context, user *model.Detail, pass string) (i1 int64, err error)) *AuthServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthServiceMockCreate) When(ctx context.Context, user *model.Detail, pass string) *AuthServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &AuthServiceMockCreateParams{ctx, user, pass},
	}
...
func (mmCreate *AuthServiceMock) Create(ctx context.Context, user *model.Detail, pass string) (i1 int64, err error) {
	mm_atomic.AddUint64(&mmCreate.beforeCreateCounter, 1)
	defer mm_atomic.AddUint64(&mmCreate.afterCreateCounter, 1)

	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, user, pass)
	}

	mm_params := AuthServiceMockCreateParams{ctx, user, pass}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockCreateParams{ctx, user, pass}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, user, pass)
	}
	mmCreate.t.Fatalf("Unexpected call to AuthServiceMock.Create. %v %v %v", ctx, user, pass)
	return
}
...
type mAuthServiceMockGetListLogs struct {
	mock               *AuthServiceMock
	defaultExpectation *AuthServiceMockGetListLogsExpectation
	expectations       []*AuthServiceMockGetListLogsExpectation

	callArgs []*AuthServiceMockGetListLogsParams
	mutex    sync.RWMutex
}

// AuthServiceMockGetListLogsExpectation specifies expectation struct of the AuthService.GetListLogs
type AuthServiceMockGetListLogsExpectation struct {
	mock    *AuthServiceMock
	params  *AuthServiceMockGetListLogsParams
	results *AuthServiceMockGetListLogsResults
	Counter uint64
}

// AuthServiceMockGetListLogsParams contains parameters of the AuthService.GetListLogs
type AuthServiceMockGetListLogsParams struct {
	ctx        context.Context
	pageNumber uint64
	pageSize   uint64
}

// AuthServiceMockGetListLogsResults contains results of the AuthService.GetListLogs
type AuthServiceMockGetListLogsResults struct {
	lpa1 []*model.Log
	err  error
}

// Expect sets up expected params for AuthService.GetListLogs
func (mmGetListLogs *mAuthServiceMockGetListLogs) Expect(ctx context.Context, pageNumber uint64, pageSize uint64) *mAuthServiceMockGetListLogs {
	if mmGetListLogs.mock.funcGetListLogs != nil {
		mmGetListLogs.mock.t.Fatalf("AuthServiceMock.GetListLogs mock is already set by Set")
	}

	if mmGetListLogs.defaultExpectation == nil {
		mmGetListLogs.defaultExpectation = &AuthServiceMockGetListLogsExpectation{}
	}

	mmGetListLogs.defaultExpectation.params = &AuthServiceMockGetListLogsParams{ctx, pageNumber, pageSize}
...
// Inspect accepts an inspector function that has same arguments as the AuthService.GetListLogs
func (mmGetListLogs *mAuthServiceMockGetListLogs) Inspect(f func(ctx context.Context, pageNumber uint64, pageSize uint64)) *mAuthServiceMockGetListLogs {
	if mmGetListLogs.mock.inspectFuncGetListLogs != nil {
		mmGetListLogs.mock.t.Fatalf("Inspect function is already set for AuthServiceMock.GetListLogs")
	}
...
// Return sets up results that will be returned by AuthService.GetListLogs
func (mmGetListLogs *mAuthServiceMockGetListLogs) Return(lpa1 []*model.Log, err error) *AuthServiceMock {
	if mmGetListLogs.mock.funcGetListLogs != nil {
		mmGetListLogs.mock.t.Fatalf("AuthServiceMock.GetListLogs mock is already set by Set")
	}

	if mmGetListLogs.defaultExpectation == nil {
		mmGetListLogs.defaultExpectation = &AuthServiceMockGetListLogsExpectation{mock: mmGetListLogs.mock}
	}
	mmGetListLogs.defaultExpectation.results = &AuthServiceMockGetListLogsResults{lpa1, err}
	return mmGetListLogs.mock
}

// Set uses given function f to mock the AuthService.GetListLogs method
func (mmGetListLogs *mAuthServiceMockGetListLogs) Set(f func(ctx context.Context, pageNumber uint64, pageSize uint64) (lpa1 []*model.Log, err error)) *AuthServiceMock {
	if mmGetListLogs.defaultExpectation != nil {
		mmGetListLogs.mock.t.Fatalf("Default expectation is already set for the AuthService.GetListLogs method")
	}

	if len(mmGetListLogs.expectations) > 0 {
		mmGetListLogs.mock.t.Fatalf("Some expectations are already set for the AuthService.GetListLogs method")
	}
...
// When sets expectation for the AuthService.GetListLogs which will trigger the result defined by the following
// Then helper
func (mmGetListLogs *mAuthServiceMockGetListLogs) When(ctx context.Context, pageNumber uint64, pageSize uint64) *AuthServiceMockGetListLogsExpectation {
	if mmGetListLogs.mock.funcGetListLogs != nil {
		mmGetListLogs.mock.t.Fatalf("AuthServiceMock.GetListLogs mock is already set by Set")
	}

	expectation := &AuthServiceMockGetListLogsExpectation{
		mock:   mmGetListLogs.mock,
		params: &AuthServiceMockGetListLogsParams{ctx, pageNumber, pageSize},
	}
	mmGetListLogs.expectations = append(mmGetListLogs.expectations, expectation)
	return expectation
}

// Then sets up AuthService.GetListLogs return parameters for the expectation previously defined by the When method
func (e *AuthServiceMockGetListLogsExpectation) Then(lpa1 []*model.Log, err error) *AuthServiceMock {
	e.results = &AuthServiceMockGetListLogsResults{lpa1, err}
	return e.mock
}

// GetListLogs implements service.AuthService
func (mmGetListLogs *AuthServiceMock) GetListLogs(ctx context.Context, pageNumber uint64, pageSize uint64) (lpa1 []*model.Log, err error) {
	...
	mm_params := AuthServiceMockGetListLogsParams{ctx, pageNumber, pageSize}
	...
	if mmGetListLogs.GetListLogsMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockGetListLogsParams{ctx, pageNumber, pageSize}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetListLogs.t.Errorf("AuthServiceMock.GetListLogs got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmGetListLogs.GetListLogsMock.defaultExpectation.results
		if mm_results == nil {
			mmGetListLogs.t.Fatal("No results are set for the AuthServiceMock.GetListLogs")
		}
	...
	mmGetListLogs.t.Fatalf("Unexpected call to AuthServiceMock.GetListLogs. %v %v %v", ctx, pageNumber, pageSize)
	return
}

// GetListLogsAfterCounter returns a count of finished AuthServiceMock.GetListLogs invocations
func (mmGetListLogs *AuthServiceMock) GetListLogsAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmGetListLogs.afterGetListLogsCounter)
}

// GetListLogsBeforeCounter returns a count of AuthServiceMock.GetListLogs invocations
func (mmGetListLogs *AuthServiceMock) GetListLogsBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmGetListLogs.beforeGetListLogsCounter)
}

// Calls returns a list of arguments used in each call to AuthServiceMock.GetListLogs.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmGetListLogs *mAuthServiceMockGetListLogs) Calls() []*AuthServiceMockGetListLogsParams {
	mmGetListLogs.mutex.RLock()

	argCopy := make([]*AuthServiceMockGetListLogsParams, len(mmGetListLogs.callArgs))
...
// the number of defined expectations
func (m *AuthServiceMock) MinimockGetListLogsDone() bool {
...
func (m *AuthServiceMock) MinimockGetListLogsInspect() {
	for _, e := range m.GetListLogsMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to AuthServiceMock.GetListLogs with params: %#v", *e.params)
		}
	}
	...
	if m.GetListLogsMock.defaultExpectation != nil && mm_atomic.LoadUint64(&m.afterGetListLogsCounter) < 1 {
		if m.GetListLogsMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to AuthServiceMock.GetListLogs")
		} else {
			m.t.Errorf("Expected call to AuthServiceMock.GetListLogs with params: %#v", *m.GetListLogsMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetListLogs != nil && mm_atomic.LoadUint64(&m.afterGetListLogsCounter) < 1 {
...
func (mmUpdate *mAuthServiceMockUpdate) Expect(ctx context.Context, updateUser *model.UpdateUserRequest) *mAuthServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthServiceMockUpdateParams{ctx, updateUser}
...
func (mmUpdate *mAuthServiceMockUpdate) Inspect(f func(ctx context.Context, updateUser *model.UpdateUserRequest)) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) Set(f func(ctx context.Context, updateUser *model.UpdateUserRequest) (err error)) *AuthServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthServiceMockUpdate) When(ctx context.Context, updateUser *model.UpdateUserRequest) *AuthServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &AuthServiceMockUpdateParams{ctx, updateUser},
	}
...
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, updateUser *model.UpdateUserRequest) (err error) {
	...
	mm_params := AuthServiceMockUpdateParams{ctx, updateUser}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockUpdateParams{ctx, updateUser}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthServiceMock.Update. %v %v", ctx, updateUser)
	return
}
